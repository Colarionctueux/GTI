...
<main>
  ...
  <section class="accueil">
    ...
    <div class="fournisseurs">
      ...
      <img src="/assets/wago.png" alt="logo fournisseur trend" />
      <img src="/assets/distech.png" alt="logo fournisseur trend" />
      <p>Voir d'autres</p>
    </div>
  </section>
  <Contacts />
  <section class="competences-title">
    <h2>
      Nous travaillons dans <br />
      de nombreux domaines <br />
...
<style>
  ...
  nav p {
    color: #002b3d;
    margin-bottom: 0;
    background: linear-gradient(to bottom, #ffffff00 96%, #002b3d 96%);
    margin-left: 25px;
    margin-right: 25px;
    font-size: 1.6em;
    font-weight: 200;
  ...
  .fournisseurs > img:nth-child(1) {
    position: absolute;
    top: 0;
    left: 10%;
  }

  .fournisseurs > img:nth-child(2) {
    position: absolute;
    top: 25%;
    right: 5%;
  }
